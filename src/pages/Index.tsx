    ...
    <main id="top">
        ...
        <div className="grid md:grid-cols-2 items-center gap-10">
          <div>
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-prose">
              The world's first Kaspa-powered streaming platform. Stream live,
              earn with zero-fee KAS tips, and build your community on
              decentralized infrastructure powered by Livepeer.
            </p>
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Most liked clips from our community
            </p>
          </div>
          <Button
            variant="outline"
      ...
      <section className="container mx-auto px-4 mt-16">
        <div className="text-center mb-8">
          <h2 className="font-semibold text-xl mb-2 bg-gradient-to-r from-brand-cyan via-brand-iris to-brand-pink bg-clip-text text-transparent">
