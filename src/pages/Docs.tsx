      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-background border-r border-border z-40 hidden lg:block">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <a href="#getting-started" onClick={(e) => { e.preventDefault(); document.getElementById('getting-started')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Getting Started</a>
            <a href="#watching" onClick={(e) => { e.preventDefault(); document.getElementById('watching')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Watching Streams</a>
            <a href="#tipping" onClick={(e) => { e.preventDefault(); document.getElementById('tipping')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Tipping with KAS</a>
            <a href="#streaming" onClick={(e) => { e.preventDefault(); document.getElementById('streaming')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Live Streaming</a>
            <a href="#clips" onClick={(e) => { e.preventDefault(); document.getElementById('clips')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Creating Clips</a>
            <a href="#verification" onClick={(e) => { e.preventDefault(); document.getElementById('verification')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Getting Verified</a>
            <a href="#profile" onClick={(e) => { e.preventDefault(); document.getElementById('profile')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Profile Management</a>
            <a href="#following" onClick={(e) => { e.preventDefault(); document.getElementById('following')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); }} className="block text-sm hover:text-primary transition-colors py-1 cursor-pointer">Following Users</a>
          </nav>
        </div>
      </div>
