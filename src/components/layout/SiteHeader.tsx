              ...
              {mobileMenuOpen && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute top-full right-0 mt-2 w-72 p-4 bg-gradient-to-br from-background/95 via-background/90 to-background/95 backdrop-blur-lg border border-border/50 rounded-xl shadow-2xl z-[10001]"
                    style={{
