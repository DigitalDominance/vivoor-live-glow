      ...
      <DialogContent className="sm:max-w-[500px] bg-gradient-to-br from-[hsl(var(--brand-cyan)_/_0.15)] via-[hsl(var(--brand-iris)_/_0.15)] to-[hsl(var(--brand-pink)_/_0.15)] backdrop-blur-2xl border border-white/20 shadow-2xl">
        <DialogHeader>
          ...
          <div className="text-sm text-foreground/80">
            Total: <span className="font-bold bg-gradient-to-r from-[hsl(var(--brand-cyan))] to-[hsl(var(--brand-iris))] bg-clip-text text-transparent">{totalAmount} KAS</span> from {donations.length} donation{donations.length !== 1 ? 's' : ''}
          </div>
        </DialogHeader>
              ...
              {sortedDonations.map((donation) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <Avatar className="h-10 w-10 flex-shrink-0 ring-2 ring-[hsl(var(--brand-iris)_/_0.5)] mt-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {donation.message && (
                        <p className="text-sm text-foreground/70 break-words mt-1">
                          {donation.message}
                        </p>
                      )}
