        ...
        >
          ...
          <div className="relative rounded-xl p-[2px] bg-gradient-to-r from-brand-cyan via-brand-iris to-brand-pink">
            <div className="bg-black/95 backdrop-blur-md rounded-[10px] p-4 shadow-2xl">
              ...
              <div className="flex items-center gap-2 mb-4 ml-25" style={{ marginTop: '50px' }}>
                ...
                <span className="text-white font-bold text-3xl truncate -mt-12">
                  {tip.sender}
                </span>
              </div>
              ...
              {tip.message && (
                <motion.div
                  ...
                  className="text-white/90 text-xs bg-white/5 rounded-lg p-3 border border-white/10 break-words leading-relaxed"
