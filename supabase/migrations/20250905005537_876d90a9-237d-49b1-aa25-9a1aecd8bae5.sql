...
-- Drop and recreate profile function to include banned status
DROP FUNCTION IF EXISTS public.get_public_profile_secure(text);
CREATE FUNCTION public.get_public_profile_secure(_id text)
