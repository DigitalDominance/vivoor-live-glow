...
DROP FUNCTION IF EXISTS public.create_stream_secure(text, text, text, text, text, text, text, boolean);
DROP FUNCTION IF EXISTS public.update_username_secure(text, text, text);
DROP FUNCTION IF EXISTS public.update_avatar_secure(text, text, text);
DROP FUNCTION IF EXISTS public.update_bio_secure(text, text, text);
DROP FUNCTION IF EXISTS public.update_banner_secure(text, text, text);
DROP FUNCTION IF EXISTS public.invalidate_wallet_session(text);
